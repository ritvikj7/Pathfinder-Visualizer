            ...
            if self.headchange:
                if self.map_obj.get_array()[x][y].classification == "block":
                    ...
                    if self.headpos:
                        ...
                        self.map_obj.get_array()[int(self.headpos.x() // self.box_width)][
                            int(self.headpos.y() // self.box_height)].set_classification("block")
                    ...
                    self.head_text_item.setPos(
                        (x * self.box_width) + self.box_width / 2 - self.head_text_item.boundingRect().width() / 2,
            ...
            if self.tailchange:
                if self.map_obj.get_array()[x][y].classification == "block":
                    ...
                    if self.tailpos:
                        ...
                        self.map_obj.get_array()[int(self.tailpos.x() // self.box_width)][
                            int(self.tailpos.y() // self.box_height)].set_classification("block")
                    ...
                    self.tail_text_item.setPos(
                        (x * self.box_width) + self.box_width / 2 - self.tail_text_item.boundingRect().width() / 2,
